...
export function createThemes({
  ...
  const color = {
    ...
    gray_0: `hsl(${hues.primary}, 15%, ${defaultScale[14]}%)`,
    gray_25: `hsl(${hues.primary}, 15%, ${defaultScale[13]}%)`,
    gray_50: `hsl(${hues.primary}, 15%, ${defaultScale[12]}%)`,
    gray_100: `hsl(${hues.primary}, 15%, ${defaultScale[11]}%)`,
    gray_200: `hsl(${hues.primary}, 15%, ${defaultScale[10]}%)`,
    gray_300: `hsl(${hues.primary}, 15%, ${defaultScale[9]}%)`,
    gray_400: `hsl(${hues.primary}, 15%, ${defaultScale[8]}%)`,
    gray_500: `hsl(${hues.primary}, 15%, ${defaultScale[7]}%)`,
    gray_600: `hsl(${hues.primary}, 19%, ${defaultScale[6]}%)`,
    gray_700: `hsl(${hues.primary}, 19%, ${defaultScale[5]}%)`,
    gray_800: `hsl(${hues.primary}, 23%, ${defaultScale[4]}%)`,
    gray_900: `hsl(${hues.primary}, 23%, ${defaultScale[3]}%)`,
    gray_950: `hsl(${hues.primary}, 23%, ${defaultScale[2]}%)`,
    gray_975: `hsl(${hues.primary}, 23%, ${defaultScale[1]}%)`,
    gray_1000: `hsl(${hues.primary}, 23%, ${defaultScale[0]}%)`,

    primary_25: `hsl(47, 35%, 97%)`,
    primary_50: `hsl(47, 35%, 95%)`,
    primary_100: `hsl(47, 35%, 90%)`,
    primary_200: `hsl(47, 37%, 80%)`,
    primary_300: `hsl(47, 39%, 70%)`,
    primary_400: `hsl(47, 40%, 58%)`,
    primary_500: `hsl(47, 40%, 45%)`,
    primary_600: `hsl(47, 43%, 38%)`,
    primary_700: `hsl(47, 45%, 32%)`,
    primary_800: `hsl(47, 47%, 25%)`,
    primary_900: `hsl(47, 50%, 18%)`,
    primary_950: `hsl(47, 53%, 10%)`,
    primary_975: `hsl(47, 55%, 7%)`,
  ...
  const dimPalette: Palette = {
    ...darkPalette,
    black: `hsl(${hues.primary}, 3%, ${dimScale[0]}%)`,
    like: color.like,

    contrast_25: `hsl(${hues.primary}, 20%, ${dimScale[1]}%)`,
    contrast_50: `hsl(${hues.primary}, 20%, ${dimScale[2]}%)`,
    contrast_100: `hsl(${hues.primary}, 20%, ${dimScale[3]}%)`,
    contrast_200: `hsl(${hues.primary}, 20%, ${dimScale[4]}%)`,
    contrast_300: `hsl(${hues.primary}, 16%, ${dimScale[5]}%)`,
    contrast_400: `hsl(${hues.primary}, 16%, ${dimScale[6]}%)`,
    contrast_500: `hsl(${hues.primary}, 12%, ${dimScale[7]}%)`,
    contrast_600: `hsl(${hues.primary}, 12%, ${dimScale[8]}%)`,
    contrast_700: `hsl(${hues.primary}, 12%, ${dimScale[9]}%)`,
    contrast_800: `hsl(${hues.primary}, 12%, ${dimScale[10]}%)`,
    contrast_900: `hsl(${hues.primary}, 12%, ${dimScale[11]}%)`,
    contrast_950: `hsl(${hues.primary}, 12%, ${dimScale[12]}%)`,
    contrast_975: `hsl(${hues.primary}, 12%, ${dimScale[13]}%)`,

    primary_25: `hsl(47, 30%, ${dimScale[1] * 0.85}%)`,
    primary_50: `hsl(47, 33%, ${dimScale[2] * 0.85}%)`,
    primary_100: `hsl(47, 35%, ${dimScale[3] * 0.85}%)`,
    primary_200: `hsl(47, 40%, ${dimScale[4] * 0.85}%)`,
    primary_300: `hsl(47, 43%, ${dimScale[5] * 0.85}%)`,
    primary_400: `hsl(47, 47%, ${dimScale[6] * 0.85}%)`,
    primary_500: `hsl(47, 50%, ${dimScale[7] * 0.85}%)`,
    primary_600: `hsl(47, 53%, ${dimScale[8] * 0.85}%)`,
    primary_700: `hsl(47, 57%, ${dimScale[9] * 0.85}%)`,
    primary_800: `hsl(47, 60%, ${dimScale[10] * 0.85}%)`,
    primary_900: `hsl(47, 63%, ${dimScale[11] * 0.85}%)`,
    primary_950: `hsl(47, 65%, ${dimScale[12] * 0.85}%)`,
    primary_975: `hsl(47, 70%, ${dimScale[13] * 0.85}%)`,
  ...
  const dim: Theme = {
    ...
    atoms: {
      ...
      shadow_sm: {
        ...atoms.shadow_sm,
        shadowOpacity: 0.7,
        shadowColor: `hsl(${hues.primary}, 20%, 6%)`,
      },
      shadow_md: {
        ...atoms.shadow_md,
        shadowOpacity: 0.7,
